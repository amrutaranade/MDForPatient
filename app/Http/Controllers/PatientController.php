    ...
    public function saveContactPartyFormSection2(Request $request)
    {
        ...
        $contactParty = ContactParty::updateOrCreate(
            ...
            [
                ...
                "phone_number" => $requestData["relationship_phone_number"] ?? null,
                "preferred_mode_of_communication" => $requestData["relationship_preferred_mode_of_communication"] ?? null, 
                "preferred_contact_time" => $requestData["relationship_preferred_contact_time"] ?? null,
                "first_name" => $requestData["relationship_first_name"] ?? null,
                "last_name" => $requestData["relationship_last_name"] ?? null,
                "NPI" => $requestData["relationship_npi"] ?? null,
                "street_address" => $requestData["relationship_street_address"] ?? null,
                "city" => $requestData["relationship_city"] ?? null,
                "postal_code" => $requestData["relationship_postal_code"] ?? null,
                "country" => $requestData["relationship_countries"] ?? null,
                "state" => $requestData["relationship_states"] ?? null,
                "Instituton" => $requestData["relationship_institution"] ?? null,
                "fax_number" => $requestData["relationship_fax_no"] ?? null,
                "relationship_other" => $requestData["relationship_other"] ?? null,
            ]
        );
