...
class PatientController extends Controller
{
    ...
    {   
        try {
            ...
            Log::info('Error in patient form view : ' . $e->getMessage());
    ...
    private function deleteIncompleteFormData($patientId)
    {
        try {
            ...
            // Handle the exception here
            Log::info('Error in deleting incomplete form data: ' . $e->getMessage());
            return response()->json(['error' => 'An error occurred. Please try again later.'], 500);
        }
    }
    ...
    public function savePatientsDetailsFormSection1(Request $request)
    {
        try {
            ...
            // Handle the exception here
            Log::info('Error in saving patient details: ' . $e->getMessage());
            return response()->json(['error' => 'An error occurred. Please try again later.'], 500);
        }
    }
    ...
    public function saveContactPartyFormSection2(Request $request)
    {
        try {
            ...
            // Handle the exception here
            Log::info('Error in saving contact party : ' . $e->getMessage());
            return response()->json(['error' => 'An error occurred. Please try again later.'], 500);
        }
    }
    ...
    public function savePatientsPhysicianFormSection3(Request $request)
    {
        try {
            ...
            // Handle the exception here
            Log::info("Error in saving patient's physician data: " . $e->getMessage());
            return response()->json(['error' => 'An error occurred. Please try again later.'], 500);
        }
    }
    ...
    public function savePrimaryConcernsFormSection4(Request $request)
    {
        try {
            ...
            // Handle the exception here
            Log::info('Error in saving primary concern : ' . $e->getMessage());
            return response()->json(['error' => 'An error occurred. Please try again later.'], 500);
        }
    }
    ...
    public function checkEmail(Request $request)
    {
        try {
            ...
            // Handle the exception here
            Log::info('Error in checkin mail : ' . $e->getMessage());
            return response()->json(['error' => 'An error occurred. Please try again later.'], 500);
        }
    }
    ...
    public function finalSubmission() {
        try {
            ...
            if($patientId){
                ...
                $this->emailController->sendWelcomEmail($recipientEmail, $details, null, null);
    ...
    public function getShareFilesByFolderId($folderId){
        try {
            ...
            Log::info('Error in getShareFilesByFolderId : ' . $e->getMessage());
            return response()->json(['error' => $e->getMessage()], 500);
        }
    }
    ...
    public function discardApplication() {
        try {
            ...
            // Handle the exception here
            Log::info('Error in discarding application: ' . $e->getMessage());
            return response()->json(['error' => 'An error occurred. Please try again later.'], 500);
        }
    }
