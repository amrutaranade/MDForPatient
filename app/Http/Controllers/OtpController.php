...
class OtpController extends Controller
{
    ...
    public function generateOtp($patientId)
    {
        try {
            ...
            Log::info('Error in generating OTP: ' . $e->getMessage());
    ...
    public function verifyOtp(Request $request)
    {
        try {
            ...
            Log::info('Error in verifying OTP : ' . $e->getMessage());
    ...
    public function validateCaseNumber(Request $request) {
        try {
            ...
            // Handle any exceptions that occur during case number validation
            Log::info('Error in validaing case number: ' . $e->getMessage());
            return response()->json(['message' => 'Failed to validate case number.'], 500);
        }
    }
    ...
    public function patientConsultationView ($patientId)
    {
        try {
            ...
            // Handle any exceptions that occur during patient consultation view
            Log::info('Error in patient consultation view: ' . $e->getMessage());
            return response()->json(['message' => 'Failed to load patient consultation view.'], 500);
        }
    }
    ...
    public function viewFile($id)
    {
        try {
            ...
            Log::info('Error in viewing file: ' . $e->getMessage());
            return abort(500, 'Failed to download file');
        }
    }
