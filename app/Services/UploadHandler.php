...
// app/Services/UploadHandler.php
...
class UploadHandler {
    ...
    public $chunksFolder = '../../data/chunks';
    ...
    public function handleUpload($uploadDirectory, $name = null){
        ...
        if ($this->toBytes($post_max_size) < $this->sizeLimit ||
            $this->toBytes($upload_max_filesize) < $this->sizeLimit) {
