                    ...
                    <div class="card-body">
                        ...
                        <form id="progress-form" class="p-4 progress-form" action="https://httpbin.org/post" lang="en" novalidate>
                            ...
                            <div class="d-flex align-items-start mb-3 sm:mb-5 progress-form__tabs" role="tablist">
                                ...
                                <button id="progress-form__tab-2" class="flex-1 px-0 pt-2 progress-form__tabs-item" type="button" role="tab" aria-controls="progress-form__panel-2" aria-selected="false" tabindex="-1" >
                                    <span class="d-block step" aria-hidden="true">Step 2 <span class="sm:d-none">of 7</span></span>
                                    Contact<br/>Party
                                </button>
                                <button id="progress-form__tab-3" class="flex-1 px-0 pt-2 progress-form__tabs-item" type="button" role="tab" aria-controls="progress-form__panel-3" aria-selected="false" tabindex="-1" >
                                    <span class="d-block step" aria-hidden="true">Step 3 <span class="sm:d-none">of 7</span></span>
                                    Patient's<br/>Physician
                                </button>
                                <button id="progress-form__tab-4" class="flex-1 px-0 pt-2 progress-form__tabs-item" type="button" role="tab" aria-controls="progress-form__panel-4" aria-selected="false" tabindex="-1" >
                                    <span class="d-block step" aria-hidden="true">Step 4 <span class="sm:d-none">of 7</span></span>
                                    Primary<br/>Concern
                                </button>
                                <button id="progress-form__tab-5" class="flex-1 px-0 pt-2 progress-form__tabs-item" type="button" role="tab" aria-controls="progress-form__panel-5" aria-selected="false" tabindex="-1" >
                                    <span class="d-block step" aria-hidden="true">Step 5 <span class="sm:d-none">of 7</span></span>
                                    Payment
                                </button>
                                <button id="progress-form__tab-6" class="flex-1 px-0 pt-2 progress-form__tabs-item" type="button" role="tab" aria-controls="progress-form__panel-6" aria-selected="false" tabindex="-1" >
                                    <span class="d-block step" aria-hidden="true">Step 6 <span class="sm:d-none">of 7</span></span>
                                    Consent
                                </button>
                                <button id="progress-form__tab-7" class="flex-1 px-0 pt-2 progress-form__tabs-item" type="button" role="tab" aria-controls="progress-form__panel-7" aria-selected="false" tabindex="-1" >
                            ...
                            <section id="progress-form__panel-2" role="tabpanel" aria-labelledby="progress-form__tab-2" tabindex="0" hidden>
                                ...
                                <h4 class="fw-bold">This is the party responsible for this case. They may be contacted about patient information, medical records, payment, and the case report as applicable.<br/><br/></h3>
                                </div>
                                <div class="mt-3 form__field">
                                    <label for="address">
