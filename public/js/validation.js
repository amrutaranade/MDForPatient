...
$(document).ready(function () {
  ...
  $('#progress-form').validate({
    ...
    messages: (_messages = {
    ...
    }, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_messages, "relationship_confirm_email", {
      equalTo: "Email addresses do not match."
    }), "relationship_phone_number", {
      ...
      strictEmail: "Please enter a valid email addres.s"
    }), _defineProperty(_messages, "confirm_email_step3", {
      equalTo: "Email addresses do not match."
    })),
    errorElement: 'p',
    // Use a span element for error messages
    errorClass: 'form__error-text',
    // Add the 'text-danger' class to the error messages
